...
namespace practica1.Repositories
{
    public class PersonRepository
    {
        ...
        //4.- Escribe un método que retorne la información ordenas por edad para las personas que sean mayores a 40 años
        public IEnumerable<Person> MayorCuarentaAños()
        {
            var age = 40;
        ...
        public IEnumerable<Person> GetByAges()
        {
         ...
         //8.- Escribe un método que retorne la información de todas las personas cuya edad se encuentre entre los 20 y 30 años.
